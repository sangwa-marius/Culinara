      ...
      <div className="px-3 py-2 border-t border-cream-300 dark:border-stone-800 space-y-0.5">
        {BOTTOM.map(({ to, label, icon: Icon, badge }) => (
          ...
          >
            ...
            {label}
            {badge && unreadCount > 0 && (
              <span className="ml-auto w-3.5 h-3.5 rounded-full flex items-center justify-center text-[8px] font-bold bg-red-500 text-white">
      ...
      >
        ...
        {menuOpen && (
          <div className="mt-1 bg-white dark:bg-stone-900 border border-cream-300 dark:border-stone-700 rounded-xl shadow-lg overflow-hidden animate-slide-up">
            <Link
              to="/driver/profile"
              className="flex items-center gap-2.5 px-3.5 py-2.5 text-xs text-stone-600 dark:text-stone-300 hover:bg-cream-100 dark:hover:bg-stone-800 transition-colors"
            >
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-cream-100 dark:bg-stone-950">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <header className="p-4 bg-white dark:bg-stone-950/90 border-b border-cream-300 dark:border-stone-800 flex items-center justify-between px-4 sm:px-6 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline-block text-xs text-stone-400 bg-stone-100 dark:bg-stone-800 px-2 py-0.5 rounded font-medium">
              Driver Portal
            </span>
          </div>
