...
import {
  ...
  CreditCard, Sun, Moon, LogOut, ChevronDown, Home,
} from "lucide-react";
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-14 bg-white dark:bg-stone-900 border-b border-cream-300 dark:border-stone-800 flex items-center justify-between px-6 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-stone-400 bg-stone-100 dark:bg-stone-800 px-2 py-0.5 rounded font-medium">Admin</span>
          </div>
