...
const TARGETS = [
  ...
  },
  {
    ...
    label: "Customers",
    icon: Users,
    desc: "Users who place orders",
  },
  {
    value: "restaurant_owners",
    label: "Restaurant Owners",
    icon: Store,
    desc: "Users who manage restaurants",
  },
  {
    value: "delivery_drivers",
    label: "Delivery Drivers",
    icon: Truck,
    desc: "Users who deliver orders",
  },
];
...
const TYPES = [
  {
    ...
    label: "System",
    emoji: "📢",
    desc: "Platform-wide announcement",
  },
  {
    value: "promo",
    label: "Promotion",
    emoji: "🎉",
    desc: "Deals and discounts",
  },
  ...
  return (
    <div className="p-6">
      <div className="max-w-2xl space-y-5">
        <div>
          <h1 className="font-bold text-stone-900 dark:text-white text-xl">
            Send Notifications
          </h1>
          <p className="text-xs text-stone-400 mt-0.5">
            Broadcast messages to users in real-time
          </p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {TARGETS.map((t) => (
                  ...
                  >
                    ...
                    <div>
                      <p
                        className={`text-sm font-semibold leading-tight ${form.target === t.value ? "text-primary-700 dark:text-primary-300" : "text-stone-700 dark:text-stone-200"}`}
                      >
                        {t.label}
                      </p>
