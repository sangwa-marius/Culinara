...
const RestaurantDashboard = lazy(
  () => import("./pages/dashboard/RestaurantDashboard"),
);
const RestaurantOrders = lazy(
  () => import("./pages/dashboard/RestaurantOrders"),
);
const RestaurantAnalytics = lazy(
  () => import("./pages/dashboard/RestaurantAnalytics"),
);
              ...
              <CartProvider>
                <Toaster
                  ...
                  toastOptions={{
                    ...
                    success: {
                      iconTheme: { primary: "#B5390D", secondary: "#fff" },
                    },
                  }}
                />
                ...
                <Suspense fallback={<PageLoader />}>
                  <Routes>
                    ...
                    />
                    <Route
                      path="/t/:restaurantId/:tableNumber"
                      element={
                        <PublicLayout>
                          <TablePublic />
                        </PublicLayout>
                      ...
                      element={
                        <PublicLayout>
                          <div className="min-h-screen pt-32 flex flex-col items-center justify-center text-center px-4">
                            ...
                            <h1 className="font-display text-4xl font-bold text-stone-900 dark:text-white mb-3">
                              Page Not Found
                            </h1>
